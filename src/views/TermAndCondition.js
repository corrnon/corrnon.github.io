  ...
  return (
    <div className="pt-9">
      <div class="container mb-5 mt-5">
        <h1 className="text-uppercase text-center mb-4 font-weight-bold">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Corrnon Team.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Corrnon, accessible from{" "}
              <a href="https://corrnon.com/" rel="noreferrer" target="_blank">
                https://corrnon.com/
              </a>
            </p>
          </li>
        ...
        <ul>
          <li>By email: corrnon@gmail.com</li>
        </ul>
      </div>
    </div>
  );
